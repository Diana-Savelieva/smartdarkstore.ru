          ...
          <div className="space-y-12 md:space-y-16">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-10 items-center">
              <div className="relative">
                <img 
                  src="/lovable-uploads/heat-map-cropped.png" 
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-10 items-center">
              ...
              <div className="relative order-1 lg:order-2">
                <img 
                  src="/lovable-uploads/shelf-recommendations-cropped.png" 
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-10 items-center">
              <div className="relative">
                <img 
                  src="/lovable-uploads/rack-optimization-cropped.png" 
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-10 items-center">
              ...
              <div className="relative order-1 lg:order-2">
                <img 
                  src="/lovable-uploads/efficiency-analysis-cropped.png" 
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-10 items-center">
              <div className="relative">
                <img 
                  src="/lovable-uploads/analytics-relocated-cropped.png" 
