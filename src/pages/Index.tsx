            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-2xl p-6 shadow-lg border border-blue-100">
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-4 group hover:bg-blue-50 p-2 rounded-lg transition-all duration-200">
                    <div className="flex-shrink-0 w-3 h-3 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full mt-1.5 group-hover:scale-110 transition-transform shadow-md"></div>
                    <span className="text-gray-700 leading-relaxed group-hover:text-blue-800 transition-colors">Аналитика сканирований продуктов</span>
                  </div>
                  <div className="flex items-start gap-4 group hover:bg-blue-50 p-2 rounded-lg transition-all duration-200">
                    <div className="flex-shrink-0 w-3 h-3 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full mt-1.5 group-hover:scale-110 transition-transform shadow-md"></div>
                    <span className="text-gray-700 leading-relaxed group-hover:text-blue-800 transition-colors">Перемещенные/мульти-расположенные товары</span>
                  </div>
                  <div className="flex items-start gap-4 group hover:bg-blue-50 p-2 rounded-lg transition-all duration-200">
                    <div className="flex-shrink-0 w-3 h-3 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full mt-1.5 group-hover:scale-110 transition-transform shadow-md"></div>
                    <span className="text-gray-700 leading-relaxed group-hover:text-blue-800 transition-colors">Рекомендации по перемещению уровней полок</span>
                  </div>
                  <div className="flex items-start gap-4 group hover:bg-blue-50 p-2 rounded-lg transition-all duration-200">
                    <div className="flex-shrink-0 w-3 h-3 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full mt-1.5 group-hover:scale-110 transition-transform shadow-md"></div>
                    <span className="text-gray-700 leading-relaxed group-hover:text-blue-800 transition-colors">Рекомендации по перестановке стеллажей</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="relative flex justify-center">
              <div className="relative">
                ...
                <img 
                  ...
                  className="relative w-full max-w-lg h-auto rounded-2xl shadow-2xl border border-blue-200"
                />
              </div>
            </div>
          </div>
